      ...
      <Teleport to="#navbar-actions">
        <div class="flex items-center gap-4">
          ...
          <UButton 
            ...
            :color="isPublished ? 'neutral' : 'violet'" 
            @click="togglePublish"
          >
            ...
            <div class="flex flex-col gap-8 text-center py-8 px-4">
              ...
              <div class="mt-8 pt-8 border-t border-neutral-200 dark:border-neutral-800">
                ...
                <div 
                  ...
                  class="mt-6 inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-violet-50 text-violet-700 dark:bg-violet-950 dark:text-violet-400 rounded-lg font-semibold text-sm"
                >
